...
namespace CONSTANTS
{
	...
	static const std::string ENEMY_SPRITE_FILENAME = "enemy.jpg";
	static const std::string PLAYER_SPRITE_FILENAME = "player.jpg";
	...
	static const std::string BOMB_SPRITE_FILENAME = "bomb.png";
	static const std::string SEA_SPRITE_FILENAME = "sea.jpg";
};
